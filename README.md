...
> 引导 A-Level/EPQ 学生确定 5000 字论文研究方向的 OpenClaw Skill

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)

## 这是什么

一个 OpenClaw skill,把一线 EPQ 老师的 3 套定题引导方法沉淀为可被 AI 复用的工作流:
...
- `SKILL.md` —— 完整的 skill 定义(3 套方法 / 3 公式 / 5 雷区 / 7 防误操作 / 3 案例)
- `CHANGELOG.md` —— 版本历史
- `LICENSE` —— MIT 许可证
