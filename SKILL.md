...
For Proposal Section 2 / Reasons for choosing the project, read [Proposal Section 2](references/proposal-section2.md). Keep personal motivation, subject/future connection, and the reason for choosing this particular question separate from Section 1's objectives and skills. Check theoretical accuracy and certainty of claims before polishing the student's English.
